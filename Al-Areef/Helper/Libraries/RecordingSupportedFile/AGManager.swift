...
class AGManager: NSObject, SendTimer {
    func sendttimer(intreval: TimeInterval, time: String) {
        timerdelegt?.sendttimer(intreval1: intreval, tim1e: time)
    }
    
    
     var fileManager: AGFileManager
    var delegate: AGManagerDelegate?
    var timerdelegt :  MainTimeofPlayer? = nil
    ...
    private func initialize() {
        ...
        self.recorder?.delegetTimer = self
