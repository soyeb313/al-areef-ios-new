...
- (void)layoutLayersAnimated:(BOOL)animated
{
    ...
    if (self.sliderCircleImage) {
        ...
        _sliderCircleLayer.strokeColor = [UIColor grayColor].CGColor;
        _sliderCircleLayer.lineWidth = 2.0f;
    } else {
...
{
    return [self trackCircleIsSeleceted:trackCircle] ? self.trackTintColor.CGColor : self.trackColor.CGColor;
}
